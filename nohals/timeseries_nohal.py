...
T91, lat,lon,lev,Ttime = GC.get_gc_var(rundir='tropchem_merra_4x5', variable=variable, version='12.9.1',year='2016')
...
try:
    ...
    ax.plot(gc.index, T91.Value, 'lightgreen', label='12.9.1')
