...
plt.ylim((7.5,52.5))
plt.legend()
plt.savefig('/users/mjr583/GC/post-process/plots/2014_%s_timeseries_%s.png' %(rundir,variable) )
plt.close()
...
plt.ylim((7.5,52.5))
plt.legend()
plt.savefig('/users/mjr583/GC/post-process/plots/2014_comparison_%s.png' %variable )
plt.close()
